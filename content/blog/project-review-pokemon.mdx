...
I like to think what data we will need and what data we will displaying from both API calls.
...
2. pokemonDetails - to store the details of the pokemon
...
3. selectedPokemon - to store the name of the selected pokemon

```tsx
const [selectedPokemon, setSelectedPokemon] = useState<string>("");
```

4. loading - to store the loading state of the component
...
<Callout type="warning">
	...
	will help the user know that the data is being fetched. To achive this we are
